...
#ifndef TESTCOINSUPER_WALLET_WALLET_H
#define TESTCOINSUPER_WALLET_WALLET_H
...
public:
     ...
     * on this testcoinsuper node, and set to 0 for transactions that were created
...
#endif // TESTCOINSUPER_WALLET_WALLET_H
