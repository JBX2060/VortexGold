...
#ifndef TESTCOINSUPER_QT_SENDCOINSDIALOG_H
#define TESTCOINSUPER_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending testcoinsupers */
...
#endif // TESTCOINSUPER_QT_SENDCOINSDIALOG_H
