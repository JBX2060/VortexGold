...
* testcoinsuper.conf: contains configuration settings for testcoinsuperd or testcoinsuper-qt
* testcoinsuperd.pid: stores the process id of testcoinsuperd while running
...
* debug.log: contains debug information and general logging generated by testcoinsuperd or testcoinsuper-qt
