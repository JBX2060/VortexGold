Download URL: https://sourceforge.net/projects/testcoinsuper/files/Test Coin Super/testcoinsuper-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TCS fee schedule (users still pay 0.01 TCS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #testcoinsuper00 - #testcoinsuper99
