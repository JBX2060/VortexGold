Test Coin Super Core version 0.9.4 is now available from:

  https://testcoinsuper.org/bin/0.9.4/
...
this update is incompatible with the Test Coin Super system and could lead to consensus
forks.

Test Coin Super Core released binaries from https://testcoinsuper.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~testcoinsuper/+archive/ubuntu/testcoinsuper
- A third-party or self-compiled Test Coin Super Core

upgrade to Test Coin Super Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
