Test Coin Super version 0.5.4 is now available for download at:
http://sourceforge.net/projects/testcoinsuper/files/Test Coin Super/testcoinsuper-0.5.4/
...
http://gitorious.org/testcoinsuper/testcoinsuperd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Test Coin Super-Qt notifications under Growl 1.3.
Increase required age of Test Coin Super-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTestCoinSuper properly when installing Test Coin Super-Qt over it. (Windows)
