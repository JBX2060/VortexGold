...
#ifndef TESTCOINSUPER_KEYSTORE_H
#define TESTCOINSUPER_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/testcoinsuper/bips/blob/master/bip-0013.mediawiki
...
#endif // TESTCOINSUPER_KEYSTORE_H
