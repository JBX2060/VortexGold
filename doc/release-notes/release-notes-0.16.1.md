Test Coin Super Core version 0.16.1 is now available from:

  <https://testcoinsupercore.org/bin/testcoinsuper-core-0.16.1/>
...
- #12843 `df38b13` Test starting testcoinsuperd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure testcoinsuperd processes are cleaned up when tests end (sdaftuar)
