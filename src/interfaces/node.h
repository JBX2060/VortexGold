...
#ifndef TESTCOINSUPER_INTERFACES_NODE_H
#define TESTCOINSUPER_INTERFACES_NODE_H
...
//! Top-level interface for a testcoinsuper node (testcoinsuperd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // TESTCOINSUPER_INTERFACES_NODE_H
