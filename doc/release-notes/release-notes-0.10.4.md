Test Coin Super Core version 0.10.4 is now available from:

  <https://testcoinsuper.org/bin/testcoinsuper-core-0.10.4/>
...
- #6953 `43c2789` Split testcoinsuper-tx into its own package
- #6953 `dfe0d4d` Include testcoinsuper-tx binary on Debian/Ubuntu
