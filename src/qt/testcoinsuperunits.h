...
#ifndef TESTCOINSUPER_QT_TESTCOINSUPERUNITS_H
#define TESTCOINSUPER_QT_TESTCOINSUPERUNITS_H
...
/** Test Coin Super unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TestCoinSuperUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TestCoinSuperUnits(QObject *parent);

    /** Test Coin Super units.
      @note Source: https://en.testcoinsuper.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TCS,
...
typedef TestCoinSuperUnits::Unit TestCoinSuperUnit;

#endif // TESTCOINSUPER_QT_TESTCOINSUPERUNITS_H
