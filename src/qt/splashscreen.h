...
#ifndef TESTCOINSUPER_QT_SPLASHSCREEN_H
#define TESTCOINSUPER_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Test Coin Super Core initialization
...
#endif // TESTCOINSUPER_QT_SPLASHSCREEN_H
