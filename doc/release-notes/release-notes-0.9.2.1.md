Test Coin Super Core version 0.9.2.1 is now available from:

  https://testcoinsuper.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TCS to 0.01 TCS
...
- Fix "Start testcoinsuper on system login"
