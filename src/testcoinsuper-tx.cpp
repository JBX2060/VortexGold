...
static void SetupTestCoinSuperTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " testcoinsuper-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  testcoinsuper-tx [options] <hex-tx> [commands]  Update hex-encoded testcoinsuper transaction\n" +
            "or:     testcoinsuper-tx [options] -create [commands]   Create hex-encoded testcoinsuper transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded testcoinsuper transaction
