Test Coin Super version 0.7.2 is now available from:
  http://sourceforge.net/projects/testcoinsuper/files/Test Coin Super/testcoinsuper-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Test Coin Super-Qt to crash on Windows when exiting.
