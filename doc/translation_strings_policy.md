...
This document provides guidelines for internationalization of the Test Coin Super Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `testcoinsuper_en.ts` remains unchanged.
