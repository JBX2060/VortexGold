Test Coin Super Core version 0.13.2 is now available from:

  <https://testcoinsuper.org/bin/testcoinsuper-core-0.13.2/>
...
- #8908 `4a974b2` Update testcoinsuper-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow testcoinsuper-tx to create v2 transactions (btcdrak)
