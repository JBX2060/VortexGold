...
#ifndef TESTCOINSUPER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define TESTCOINSUPER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // TESTCOINSUPER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
