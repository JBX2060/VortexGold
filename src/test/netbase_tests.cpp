...
{
    BOOST_CHECK(TestSplitHost("www.testcoinsupercore.org", "www.testcoinsupercore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.testcoinsupercore.org]", "www.testcoinsupercore.org", -1));
    BOOST_CHECK(TestSplitHost("www.testcoinsupercore.org:80", "www.testcoinsupercore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.testcoinsupercore.org]:80", "www.testcoinsupercore.org", 80));
