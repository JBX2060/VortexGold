...
"""Verify that starting testcoinsuper with -h works as expected."""

from test_framework.test_framework import TestCoinSuperTestFramework
from test_framework.util import assert_equal

class HelpTest(TestCoinSuperTestFramework):
    ...
    def run_test(self):
        self.log.info("Start testcoinsuper with -h for help text")
        ...
        self.log.info("Start testcoinsuper with -version for version information")
        ...
        self.log.info("Start testcoinsuperd with -fakearg to make sure it does not start")
