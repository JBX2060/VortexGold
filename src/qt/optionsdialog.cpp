    ...
    mapper(0)
{
    ...
    ui->testcoinsuperAtStartup->setToolTip(ui->testcoinsuperAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->testcoinsuperAtStartup->setText(ui->testcoinsuperAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openTestCoinSuperConfButton->setToolTip(ui->openTestCoinSuperConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new TestCoinSuperUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->testcoinsuperAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTestCoinSuperConfButton_clicked()
{
    ...
    if (!GUIUtil::openTestCoinSuperConf())
