...
#ifndef TESTCOINSUPER_TEST_SCRIPTNUM10_H
#define TESTCOINSUPER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Test Coin Super Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // TESTCOINSUPER_TEST_BIGNUM_H
