...
# TestP2PConn: A peer we use to send messages to testcoinsuperd, and store responses.
...
class CompactBlocksTest(TestCoinSuperTestFramework):
    ...
    # This test actually causes testcoinsuperd to (reasonably!) disconnect us, so do this last.
    ...
    # testcoinsuperd's choice of nonce.
    ...
    # Test that testcoinsuperd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for testcoinsuperd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # testcoinsuperd will not send blocktxn responses for blocks whose height is
