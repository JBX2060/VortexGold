Test Coin Super-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/testcoinsuper/files/Test Coin Super/testcoinsuper-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Test Coin Super
...
New/changed settings (command-line or testcoinsuper.conf file)
--------------------------------------------------------
