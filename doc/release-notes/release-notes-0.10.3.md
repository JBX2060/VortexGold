Test Coin Super Core version 0.10.3 is now available from:

  <https://testcoinsuper.org/bin/testcoinsuper-core-0.10.3/>
...
(see https://github.com/testcoinsuper/testcoinsuper/pull/6793, as well as the 0.11.0
