 ...
 */
#ifndef TESTCOINSUPER_UTIL_H
#define TESTCOINSUPER_UTIL_H
...
extern const char * const TESTCOINSUPER_CONF_FILENAME;
extern const char * const TESTCOINSUPER_PID_FILENAME;
...
{
    std::string s = strprintf("testcoinsuper-%s", name);
