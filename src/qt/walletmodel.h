...
#ifndef TESTCOINSUPER_QT_WALLETMODEL_H
#define TESTCOINSUPER_QT_WALLETMODEL_H
...
/** Interface to Test Coin Super wallet from Qt view code. */
...
#endif // TESTCOINSUPER_QT_WALLETMODEL_H
